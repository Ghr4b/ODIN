...
describe BinaryGame do
  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      ...
      it 'completes loop and displays error message once' do
        min = game_input.instance_variable_get(:@minimum)
        max = game_input.instance_variable_get(:@maximum)
        expect(game_input).to receive(:puts).with("Input error! Please enter a number between #{min} or #{max}.").once
        game_input.player_input(min, max)
      end
    end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      ...
      it 'completes loop and displays error message twice' do
        min = game_input.instance_variable_get(:@minimum)
        max = game_input.instance_variable_get(:@maximum)
        expect(game_input).to receive(:puts).with("Input error! Please enter a number between #{min} or #{max}.").twice
        game_input.player_input(min, max)
      end
    end
  end
  ...
  describe '#verify_input' do
    ...
    subject(:game_verify) { described_class.new(1, 100) }
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        max = game_verify.instance_variable_get(:@maximum)
        user_input = 150
        expect(game_verify.verify_input(min, max, user_input)).to be_nil
      end
    end
  end
  ...
  describe '#update_random_number' do
    ...
    context 'when updating value of random number' do
      ...
      # RandomNumber class.Project: TDD Connect Four
      ...
      Stack Overflow has an RSpec Mock Object example.
      Tutorials Point has an article about RSpec Writing Specs.
